...
//     No need use ignoringAllOverriddenEquals, see https://assertj.github.io/doc/#breaking-changes
    ...
    public static final Restaurant restaurant_1 = new Restaurant(RESTAURANT1_ID, MANAGER_ID, "Macdonalds", "Москва", "macdonalds@mac.com", 1, LocalDateTime.of(2021, Month.MAY, 1, 0, 0, 0));
    public static final Restaurant restaurant_2 = new Restaurant(RESTAURANT2_ID, ADMIN_ID, "DoDoPizza", "Мытищи", "dodo@do.com", 0, LocalDateTime.of(2021, Month.MAY, 2, 3, 0, 0));
    ...
    public static Restaurant getUpdated() {
        return new Restaurant(RESTAURANT1_ID, USER_ID, "Обновлеенное Название", "Обновленный адрес", "updated@mac.com", 0, LocalDateTime.of(2021, Month.SEPTEMBER, 5, 0, 0, 0));

    }

    public static Restaurant getNew() {
        return new Restaurant(null, ADMIN_ID, "Новое Название", "Новый адрес", "new@mac.com", 0, LocalDateTime.of(2021, Month.DECEMBER, 9, 0, 0, 0));
    }
